        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuselageLength = table.Column<double>(type: "float", nullable: false),
                    Wingspan = table.Column<double>(type: "float", nullable: false),
                    ...
                    CruiseHeight = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebuffId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Planes_AirplaneId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountFlight", x => new { x.DiscountsId, x.FlightsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnvEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EnvEvents_Flights_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightTax", x => new { x.FlightsId, x.TaxesId });
                    table.ForeignKey(
                        name: "FK_FlightTax_Flights_FlightsId",
                        column: x => x.FlightsId,
                        principalTable: "Flights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightTax_Taxes_TaxesId",
                        column: x => x.TaxesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_RowNum_ColNum_FlightId",
                table: "Reservations",
                columns: new[] { "RowNum", "ColNum", "FlightId" },
                unique: true);
